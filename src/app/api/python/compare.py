...
images_dir = '../../../../public/pictures'  # Adjust this to the correct path
...
def compare_faces(uploaded_image_path, images_dir):
    ...
    if closest_match:
        return f"Match found: {closest_match} with distance: {closest_distance:.2f}"
    else:
...
# # Define directories
# uploaded_image_dir = sys.argv[1]  # Take the image as argument
